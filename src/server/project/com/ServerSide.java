...
public class ServerSide extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Client Server File Sharing");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    serverSoc = new ServerSocket(9999);
                    txt.append("The Server is Stating...\n");
    ...
    private void listMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listMouseClicked
     ...
     private void open() {
        Data data = (Data) model.getElementAt(list.getSelectedIndex());
        if (data.getStatus().equals("Image")) {
            ImageShowing obj = new ImageShowing(this, true);
